...
int main(void)
{
	...
	while (FuncShowBlink ((const char *) "Hardware: V1.2  ", (const char *) "Software: V2.4  ", 1, BLINK_CROSS) != RESP_FINISH);
			...
			switch (signal_state)
			{
				...
				case LOOK_FOR_BREAK:
					if (DMX_INPUT)
					{
						...
						if ((aux > 87) && (aux < 4600))		//Consola marca CODE modelo A24 tiene break 4.48ms fecha 11-07-16
						{
							LED_ON;
